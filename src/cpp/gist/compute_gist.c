 ...
 *  modify by leo, leoyonn@gmail.com
 */
...
int main(int argc, char **args) {
	...
	int nblocks = 4;
	int n_scale = 4;
	int orientations_per_scale[4] = {4,4,4,4};
	...
	double *desc = color_gist_scaletab(im, nblocks, n_scale,
	...
	/* print descriptor */
	printf("nblock: %d, ", nblocks);
	for (i = 0; i < n_scale; i++) {
		printf("orient[%d]:%d, ", i, orientations_per_scale[i]);
	}
